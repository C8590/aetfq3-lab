...
def post_sprint_counts_from_rolling(rolling_report: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "post_sprint_group_count": int(fold.get("validation_group_count") or 0),
...
def build_docs(report: dict[str, Any]) -> tuple[str, dict[str, Any]]:
    ...
    lines = [
        ...
        f"- post_sprint_group_count: {report['post_sprint_group_count']}",
...
def run_refresh_gate(
    ...
    *,
    ...
    post_sprint_anchor_count = int(post_sprint_counts["post_sprint_anchor_count"])
    post_sprint_group_count = int(post_sprint_counts["post_sprint_group_count"])
    new_anchor_due = post_sprint_anchor_count >= POST_SPRINT_ANCHOR_THRESHOLD and post_sprint_group_count >= POST_SPRINT_GROUP_THRESHOLD
    ...
    report = {
        ...
        "post_sprint_group_count": post_sprint_group_count,
        "post_sprint_etf_count": post_sprint_counts["post_sprint_etf_count"],
